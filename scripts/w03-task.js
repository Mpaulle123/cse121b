...
const getResult = document.querySelector("#getTotal");
const getOutput = document.querySelector("#total");
...
function func1() {
  if (
      ...
      let discount = Number((input.value)- (input.value * 0.15));
    getOutput.innerHTML = "$ " + Number(discount).toFixed(2);
  }else  
 {
    getOutput.innerHTML = "$ " + Number(input.value * 1).toFixed(2);
  }
}
getResult.addEventListener("click", func1);
